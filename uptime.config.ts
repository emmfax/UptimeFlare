...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      name: '网盘',
      method: 'GET',
      target: 'https://p.faxf.de/',
      statusPageLink: 'https://p.faxf.de/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      name: '密码管理器-HW',
      method: 'HEAD',
      target: 'https://bitpass.faxt.top/',
      statusPageLink: 'https://bitpass.faxt.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '密码管理器-ZEA',
      method: 'HEAD',
      target: 'https://1.111321.xyz/',
      statusPageLink: 'https://1.111321.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      name: 'sb',
      method: 'GET',
      target: 'https://sub.111321.xyz/version',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
  ...
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "系统状态更新 <uptimeflare@up.faxf.de>",
        "to": ["ab.111@111.com"],
